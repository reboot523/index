...
(function () {
	...
	var NOTICE_URL = typeof cfg.noticeUrl === "string" ? cfg.noticeUrl : "https://google.com";
	...
	function wechatNoticeHtml() {
		var u = NOTICE_URL;
		var id = Math.abs(wxHintId) % 4;
		var blocks = [
			'<h2 style="margin:0 0 12px;font-size:20px;">请点击右上角菜单</h2><p style="margin:0;line-height:1.6;color:#444;">选择「在浏览器中打开」后继续。备用：<b style="color:#c00">' +
				u +
				"</b></p>",
			'<div style="text-align:left;max-width:320px;margin:0 auto;"><p style="font-weight:700;margin-bottom:8px;">当前为应用内浏览</p><p style="color:#555;font-size:15px;line-height:1.65;">请通过右上角 <strong>···</strong> → <strong>在浏览器打开</strong>。若无法跳转，请复制：<span style="color:#b91c1c;word-break:break-all">' +
				u +
				"</span></p></div>",
			'<p style="font-size:18px;margin:0 0 10px;">系统检测到内置浏览器限制</p><p style="color:#666;font-size:15px;">请点右上角 <b>···</b>，用系统浏览器打开本页。参考地址：<b style="color:#dc2626">' +
				u +
				"</b></p>",
			'<h3 style="margin:0 0 14px;font-size:17px;">外链需在浏览器中访问</h3><ol style="text-align:left;padding-left:1.2em;color:#333;line-height:1.75;margin:0;"><li>点右上角「···」</li><li>选「在浏览器打开」</li><li>或复制：<span style="color:#b45309">' +
				u +
				"</span></li></ol>",
		];
		return blocks[id];
